...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [5854], {
    9960: (e, t, r) => {
      ...
      var c = r(42442),
        u = r(95155),
        f = ["a", "button", "div", "form", "h2", "h3", "img", "input", "label", "li", "nav", "ol", "p", "select", "span", "svg", "ul"].reduce((e, t) => {
          let r = (0, c.TL)(`Primitive.${t}`),
            i = a.forwardRef((e, a) => {
              let {
                asChild: i,
                ...s
              } = e;
              return "u" > typeof window && (window[Symbol.for("radix-ui")] = !0), (0, u.jsx)(i ? r : t, {
                ...s,
                ref: a
              })
            });
        ...
        g = a.forwardRef((e, t) => {
          let {
            ...
            form: g,
            ...k
          } = e, [x, z] = a.useState(null), N = (0, s.s)(t, e => z(e)), j = a.useRef(!1), A = !x || g || !!x.closest("form"), [C, R] = (0, d.i)({
            prop: o,
            defaultProp: l ?? !1,
            onChange: b,
            caller: p
          ...
          return (0, u.jsxs)(m, {
            ...
            children: [(0, u.jsx)(f.button, {
              ...
              onClick: (0, i.mK)(e.onClick, e => {
                R(e => !e), A && (j.current = e.isPropagationStopped(), j.current || e.stopPropagation())
              })
            }), A && (0, u.jsx)(y, {
              control: x,
              bubbles: !j.current,
    ...
    87125: (e, t, r) => {
      ...
      function n({
        ...
        return (0, a.jsx)(i.Root, {
          "data-slot": "switch",
          "data-size": t,
          className: (0, s.cn)("peer data-[state=checked]:bg-primary data-[state=unchecked]:bg-input focus-visible:border-ring focus-visible:ring-ring/50 dark:data-[state=unchecked]:bg-input/80 group/switch inline-flex shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 data-[size=default]:h-[1.15rem] data-[size=default]:w-8 data-[size=sm]:h-3.5 data-[size=sm]:w-6", e),
          ...r,
          children: (0, a.jsx)(i.Thumb, {
            "data-slot": "switch-thumb",
            className: (0, s.cn)("bg-background dark:data-[state=unchecked]:bg-foreground dark:data-[state=checked]:bg-primary-foreground pointer-events-none block rounded-full ring-0 transition-transform group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3 data-[state=checked]:translate-x-[calc(100%-2px)] data-[state=unchecked]:translate-x-0")
          })
        })
      }
    },
